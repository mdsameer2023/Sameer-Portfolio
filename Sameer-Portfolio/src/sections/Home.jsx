...
const socials = [
  ...
  { Icon: FaXTwitter, label: "X", href: "https://x.com/SameerAlam4385" },
  {
    Icon: FaLinkedinIn,
    label: "LinkedIn",
  ...
  },
  {
    Icon: FaInstagram,
    label: "Instagram",
    href: "https://www.instagram.com/tech_sameer.ai/?hl=en",
  },
  {
    Icon: FaGithub,
    label: "GitHub",
    href: "https://github.com/mdsameer2023",
  },
];
...
const Home = React.forwardRef((props, ref) => {
  const roles = useMemo(
    () => ["AI Full Stack Developer", "React Developer", "Content Creator", "Software Engineer"],
    [],
  );
        ...
        <motion.div
          ...
          <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
            ...
            <motion.p
              ...
              AI. Passionate about creating fast, responsive and user-friendly
              digital experiences.
            </motion.p>
